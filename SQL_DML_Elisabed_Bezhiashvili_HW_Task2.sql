...
--This operation leaves only the toast space (8 KB), showing that the table itself has been completely emptied, and no other data remains.
--Also this operation is way faster than delete, cause it removes rows without scanning it.
--total_bytes 8192
--index bytes 0
--toast_bytes 8192 
--table_bytes 0
